...
Version  : 3.1.0
Release  : 114
URL      : https://cran.r-project.org/src/contrib/car_3.1-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/car_3.1-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655314751
